...
arguments = [
    ...
    connection.schema,
    connection.login,
    "call_tag_call_outcomes",
    f"{Variable.get('milkyway_sqoop_dest_dir')}/call_tag_call_outcomes"
]

STEPS = [
    {
        "Name": "Sqoop milkyway call tag call outcomes import",
        "HadoopJarStep": {
            "Args": arguments,
...
dag = DAG(
    'milkyway_sqoop_call_tag_call_outcomes_import',
